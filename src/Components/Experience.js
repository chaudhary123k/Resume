      ...
      <div className="section border" id='experience'  style={{backgroundColor : "#3f4953"}}>
        ...
        <div className="container px-4">
          <div className="row gx-5 my-4 mx-4">
            ...
            <div className="col-8 front">
              <div className="p-3 h4"  style={{color : "white"}}>Front End Developer</div>
        ...
        <div className="container px-4">
          <div className="row gx-5 my-4 mx-4">
            ...
            <div className="col-8 front">
              <div className="p-3 h4"  style={{color : "white"}}>JCB BONNEVILE DELIVERY</div>
        ...
        <div className="container px-4">
          <div className="row gx-5 my-4 mx-4">
            ...
            <div className="col-8 front">
              <div className="p-3 h4"  style={{color : "white"}}>Master Detail Page(SAP UI5)</div>
              ...
              <div className="p-3 h4"  style={{color : "white"}}>Covid 19 Data(SAP UI5)</div>
